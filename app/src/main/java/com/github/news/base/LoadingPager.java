...
public abstract class LoadingPager extends FrameLayout {
    ...
    private void initCommonView(Context context) {
        ...
        //加载中页面
        mLoadingView = inflater.inflate(R.layout.loadpage_loading, null, false);
        ...
        //加载错误页面
        mErrorView = inflater.inflate(R.layout.loadpage_error, null, false);
        ...
        //加载为空页面
        mEmptyView = inflater.inflate(R.layout.loadpage_empty, null, false);
        addView(mEmptyView);
    ...
    private void refreshUI() {
       ...
       /* mLoadingView.setVisibility((mCurState == STATE_LOADING || mCurState == STATE_NONE) ? View
        ...
        if (mSuccessView != null) {
            mSuccessView.setVisibility((mCurState == STATE_SUCCESS) ? View.VISIBLE : View
                    .GONE);
        }
    }
